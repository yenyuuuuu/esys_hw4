...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        if (option == 0) {
            ...
            start_advertising(_button_uuid);
        }
        else if (option == 1) {
            char id1[] = {'b', '0', '6', '9', '0', '1', '1', '0', '7'};
            char id2[] = {'b', '0', '6', '5', '0', '2', '1', '0', '6'};
            char id3[] = {'b', '0', '6', '9', '0', '1', '1', '7', '5'};
            _id_service = new IdService(_ble, id1, id2, id3);
            start_advertising(_id_uuid);
        }
    }

    void start_advertising(UUID uuid) {
        ...
        _adv_data_builder.setLocalServiceList(mbed::make_Span(&uuid, 1));
